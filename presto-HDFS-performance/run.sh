...
./presto-benchmark-driver-0.245.1-executable.jar --server ip-172-31-24-179.us-east-2.compute.internal:8889 --catalog hive --schema tpcds_bin_partitioned_orc_1000